                            ...
                            {{--@foreach($t_shirts as $t_shirt)--}}
                                <div class="products_card col-4">
                                    <div class="product_name">
                                        <p>
                                            <a href="@productLink(route('user.woman_t_shirts'),$t_shirts->routeKeyName)">{{$t_shirts->name}}</a>
                                        </p>
                                    </div>
                                    ...
                                    <div class="product_img">
                                        @if(count($t_shirts->images)===0)
                                            <p><a href="@productLink(route('user.woman_t_shirts'),$t_shirts->routeKeyName)">
